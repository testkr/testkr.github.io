window.specials = {
    ...
    583: {
        rcvStatic: function(p) { return p.unit.class.has("사격") ? 300: 0; },
    },
    589: {
    ...
    885: {
        atk: function(p) { return p.unit.class.has('격투') ? window.specials[885].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
    ...
    886: {
        atk: function(p) { return p.unit.class.has('참격') ? window.specials[886].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
            var n = (p.percHP <= 30 ? 1.5 : 1);
    ...
    1082: {
        atk: function(p) { return (p.unit.class.has("타격") || p.unit.class.has("격투")) ? window.specials[1082].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
    ...
    1083: {
        atk: function(p) { return (p.unit.class.has("타격") || p.unit.class.has("격투")) ? window.specials[1083].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
            var n = (p.percHP >= 70 ? 1.2 : p.percHP >= 30 ? 1.5 : 1.75);
    ...
    1133: {
        atk: function(p) { return p.unit.class.has("격투") || p.unit.class.has("사격") ? window.specials[1133].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
    ...
    1168: {
        atk: function(p) { return p.unit.type == "힘" ? window.specials[1168].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
    ...
    1169: {
        atk: function(p) { return p.unit.type == "힘" ? window.specials[1169].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
            var n = (p.percHP <= 10 ? 1.75 : p.percHP <= 30 ? 1.5 : p.percHP <= 50 ? 1.25 : 1.1);
    ...
    1219: {
        atk: function(p) {
            if (!window.specials[1219].stage) return p.unit.class.has("사격") ? 1.2 : 1;
            if (window.specials[1219].stage == 1) return p.unit.class.has("사격") ? 1.5 : 1;
            if (window.specials[1219].stage == 2) return p.unit.class.has("사격") ? 2 : 1;
        },
        type: "class",
        stage: -1,
        onActivation: function(p) {
    ...
    1220: {
        atk: function(p) {
            if (!window.specials[1220].stage) return p.unit.class.has("사격") ? 1.2 : 1;
            if (window.specials[1220].stage == 1) return p.unit.class.has("사격") ? 1.5 : 1;
            if (window.specials[1220].stage == 2) return p.unit.class.has("사격") ? 2 : 1;
        },
        type: "class",
        stage: -1,
        onActivation: function(p) {
    ...
    1233: {//Tashigi
        affinity: function(p){ return p.unit.class.has("참격") || p.unit.class.has("박식") ? 1.5 : 1; }
    },
    1234: {//Tashigi
        affinity: function(p){ return p.unit.class.has("참격") || p.unit.class.has("박식") ? 1.5 : 1; }
    },
    ...
    1245: {
        atk: function(p) { return !p.unit.class.has('격투') ? 1 : window.specials[1245].multiplier; },
        type: "class",
        onActivation: function(p) {
    ...
    1246: {
        atk: function(p) { return !p.unit.class.has('격투') ? 1 : window.specials[1246].multiplier; },
        type: "class",
        onActivation: function(p) {
    ...
    1247: {
        atk: function(p) { return !p.unit.class.has('격투') ? 1 : window.specials[1247].multiplier; },
        type: "class",
        onActivation: function(p) {
    ...
    1261: {//Young Senor Pink
        affinity: function(p){ return p.unit.class.has("사격") || p.unit.class.has("자유") ? 1.5 : 1; }
    },
    ...
    1297: {
        affinity: function(p){ return p.unit.type == "힘" ? 1.75 : 1; }
    },
    1298: {
        affinity: function(p){ return p.unit.type == "힘" ? 1.75 : 1; }
    },
    ...
    1329: {
        affinity: function(p){ return p.unit.class.has("격투") || p.unit.class.has("자유") ? 1.25 : 1; }
    },
    1330: {
        turnedOn: false,
        onActivation: function(p) {
    ...
    1400: {
        affinity: function(p) { return p.unit.class.has("사격") ? window.specials[1400].multiplier : 1; },
        onActivation: function(p) {
    ...
    1401: {
        affinity: function(p) { return p.unit.class.has("사격") ? window.specials[1401].multiplier : 1; },
        onActivation: function(p) {
    ...
    1402: {
        atk: function(p) { return p.unit.type == "마음" ? window.specials[1402].multiplier : 1; },
        type: "type",
        onActivation: function(p) {
    ...
    1407: {
        atk: function(p) { return p.unit.type == "마음" || p.unit.type == "기술" ? 2 : 1; },
        type: "type"
    },
    1408: {
        atk: function(p) { return p.unit.type == "마음" || p.unit.type == "기술" ? 2 : 1; },
    ...
    1409: {
        delay: function(p) { return 1; },
        atk: function(p) {
            return p.unit.class.has("참격") || p.unit.class.has("자유") ? 1.75 : 1;
        },
        type: "class"
    },
    1410: {
    ...
    1421: {
        atk: function(p) { return p.unit.class.has("야심") ? window.specials[1421].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
    ...
    1422: {
        atk: function(p) { return p.unit.class.has("야심") ? window.specials[1422].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
            var n = (p.percHP == 100 ? 2 : 1.5);
    ...
    1445: {
        delay: function(p) { return 1; },
        atk: function(p) { return p.unit.type == "마음" || p.unit.type == "속도" ? 1.75 : 1; },
        rcv: function(p) { return p.unit.type == "마음" || p.unit.type == "속도" ? 1.75 : 1; },
        type: "type"
    },
    1446: {
        delay: function(p) { return 1; },
    ...
    1476: {
        delay: function(p) { return 1; },
        atk: function(p) {
            return p.unit.class.has("타격") || p.unit.class.has("강인") ? 1.75 : 1;
        },
        type: "class"
    },
    1477: {
    ...
    1512: {
        atk: function(p) { return p.unit.class.has("강인") ? window.specials[1512].multiplier : 1; },
        type: "class",
        onActivation: function(p) {
            var n = (p.percHP <= 30 ? 1.5 : 1);
    ...
    1585: {
        atk: function(p) { return (p.percHP*p.maxHP/100 < 5000 && (p.unit.class.has("참격") || p.unit.class.has("야심"))) ? 1.75 : 1; },
        rcv: function(p) { return (p.percHP*p.maxHP/100 < 5000 && (p.unit.class.has("참격") || p.unit.class.has("야심"))) ? 1.5 : 1; },
        type: "class"
    },
    1586: {
        atk: function(p) { return (p.percHP*p.maxHP/100 < 5000 && (p.unit.class.has("참격") || p.unit.class.has("야심"))) ? 1.75 : 1; },
    ...
    1627: {
        affinity: function(p){ return p.unit.class.has("타격") ? window.specials[1627].multiplier : 1; },
        onActivation: function(p) {
    ...
    1628: {
        affinity: function(p){ return p.unit.class.has("타격") ? window.specials[1628].multiplier : 1; },
        onActivation: function(p) {
    ...
    1657: {
        chain: function(p) { return p.captain.class.has("타격") ? 2.75 : 1; },
        chainLimiter: function(p) {
            var prev = p.hitcombo[p.hitcombo.length - 1][p.chainPosition - 1]
    ...
    1664: {
        atk: function(p) { return p.captain.class.has("사격") ? p.unit.class.has("사격") ? 2 : 1 : 1; },
        type: "class",
    },
    1665: {
        atk: function(p) { return p.captain.class.has("사격") ? p.unit.class.has("사격") ? 2 : 1 : 1; },
    ...
    1677: {
        affinity: function(p){ return p.unit.class.has("참격") ? 1.5 : 1; }
    },
    1678: {
        affinity: function(p){ return p.unit.class.has("참격") ? 1.5 : 1; }
    },
    ...
    1718: {
        atk: function(p) { return p.unit.class.has("야심") ? 1.25 : 1},
        type: "class"
    },
    1720: {
        chain: function(p) { return p.captain.class.has("격투") ? 2.5 : 1; },
        chainLimiter: function(p) {
            var prev = p.hitcombo[p.hitcombo.length - 1][p.chainPosition - 1]
            return p.chainPosition === 0 ? 1 : (prev == 'Good'  || prev == 'Great' || prev == 'Perfect') ? 2.5 : 1;
        }
    ...
    1794: {
        atk: function(p) { return !(p.unit.type == "힘" || p.unit.type == "기술" || p.unit.type == "속도") ? 1 : window.specials[1794].multiplier; },
        type: "class",
        onActivation: function(p) {

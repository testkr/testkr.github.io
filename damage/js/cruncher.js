...
var CruncherCtrl = function($scope, $rootScope, $timeout) {
    ...
    var getBaseDamageForType = function(type) {
        ...
        team.forEach(function(x,n) {
            ...
            var multipliers = [ ];
            if (orb == 'g') orb = 1.5;
            if (orb == 0.5 && x.unit.type == '기술') orb = (window.specials[1221].turnedOn || window.specials[1222].turnedOn) ? 2 : 0.5;
            if (orb == 0.5 && x.unit.type == '기술' && x.unit.class.has("야심")) orb = (window.specials[1259].turnedOn || window.specials[1260].turnedOn || window.specials[1323].turnedOn || window.specials[1324].turnedOn) ? 2 : 0.5;
            if (orb == 0.5 && x.unit.type == '기술' && x.unit.class.has("참격")) orb = (window.specials[1323].turnedOn || window.specials[1324].turnedOn) ? 2 : 0.5;
            if (orb == 0.5 && x.unit.type == '기술' && x.unit.class.has("격투")) orb = (window.specials[1593].turnedOn || window.specials[1463]. turnedOn || window.specials[1462]. turnedOn) ? 2 : 0.5;
            if (orb == 0.5 && x.unit.type == '기술' && x.unit.class.has("강인")) orb = (window.specials[1528].turnedOn) ? 2 : 0.5;
            if (orb == 0.5 && x.unit.type == '기술' && x.unit.class.has("자유")) orb = (window.specials[1593].turnedOn) ? 2 : 0.5;
            if (orb == 0.5 && x.unit.type == '기술' && x.unit.class.has("사격")) orb = (window.specials[1640].turnedOn || window.specials[1746].turnedOn || window.specials[1747].turnedOn) ? 2 : 0.5;
            if (orb == 0.5 && x.unit.type == '기술' && x.unit.class.has("타격")) orb = (window.specials[1651].turnedOn || window.specials[1652].turnedOn) ? 2 : 0.5;
            if (orb == 'str') orb = (window.specials[1221].turnedOn || window.specials[1222].turnedOn 
                                     || ((window.specials[1259].turnedOn || window.specials[1260].turnedOn) && x.unit.class.has("야심"))
                                     || ((window.specials[1323].turnedOn || window.specials[1324].turnedOn) && (x.unit.class.has("야심") || x.unit.class.has("참격")))
                                     || (window.specials[1528].turnedOn && x.unit.class.has("강인"))
                                     || (window.specials[1593].turnedOn && (x.unit.class.has("격투") || x.unit.class.has("자유")))
                                     || (window.specials[1640].turnedOn && x.unit.class.has("사격"))
                                     || ((window.specials[1651].turnedOn || window.specials[1652].turnedOn) && x.unit.class.has("타격"))
                                     || ((window.specials[1746].turnedOn|| window.specials[1747].turnedOn) && x.unit.class.has("사격"))
                                     || ((window.specials[1940].turnedOn|| window.specials[1941].turnedOn) && (x.unit.type == "힘" || x.unit.type == "속도" || x.unit.type == "마음"))) ? 2 : 'str';
            ...
            if (orb =='meat'){
                for (temp = 0; temp < 2; temp++){
                    if (team[temp].unit != null){
                        ...
                        if ([ 2012, 2013 ].includes(team[temp].unit.number) && x.unit.class.has("자유")){
                            orb = 2;
                        }
                    }
                }
            ...
            if (orb == 0.5 && x.unit.type == '기술' && $scope.data.effect == 'STR Orbs Beneficial') orb = 2;
            if (orb == 'str' && $scope.data.effect == 'STR Orbs Beneficial') orb = 2;
            if (orb == 'meat') orb = 
                ((window.specials[1515].turnedOn || window.specials[1516].turnedOn || (window.specials[1593].turnedOn) && x.unit.class.has("격투")) || 
                ((window.specials[1181].turnedOn || window.specials[1182].turnedOn) && x.unit.class.has("참격")) || 
                ((window.specials[1380].turnedOn || window.specials[1379].turnedOn) && (x.unit.class.has("박식") || x.unit.class.has("자유")))) || 
                ((window.specials[2128].turnedOn) && (x.unit.class.has("참격") || x.unit.class.has("타격"))) ? 2 : 1;
    ...
    var getTypeMultiplierOfUnit = function(attackerType,attackedType, unit) {
        ...
        if (attackerType == '힘' && attackedType == '기술') typeMult = 2;
        if (attackerType == '속도' && attackedType == '힘') typeMult = 2;
        if (attackerType == '기술' && attackedType == '속도') typeMult = 2;
        if (attackerType == '지능' && attackedType == '마음') typeMult = 2;
        if (attackerType == '마음' && attackedType == '지능') typeMult = 2;
        if (attackerType == '힘' && attackedType == '속도') typeMult = 0.5;
        if (attackerType == '속도' && attackedType == '기술') typeMult = 0.5;
        if (attackerType == '기술' && attackedType == '힘') typeMult = 0.5;
    ...
    var applyChainAndBonusMultipliers = function(damage,modifiers) {
        ...
        if(shipBonus.bonus.name=="돈키호테 해적단선 - 필살기 활성화"){
            addition = 0.2
        }
        ...
        for(var z=0;z<team.length;z++){
            if(team[z].unit){
                if(team[z].unit.class.length==2){
                    if(team[z].unit.class[0] == '자유'){
                        classes['자유']++;
                    }
                    else{
                        classes[team[z].unit.class[0]]++;
                    }
                    if(team[z].unit.class[1] == '자유'){
                        classes['자유']++;
                    }
                    else{
    ...
    var frankyCheck = function() {
        ...
        //var classArray = ['Fighter', 'Slasher', 'FreeSpirit', 'Powerhouse', 'Shooter', 'Striker', '박식', 'Driven'];
        ...
        for(var z=0;z<team.length;z++){
            if(team[z].unit){
                if(team[z].unit.class.length == 2){
                    if(['격투', '참격', '사격', '타격'].includes(team[z].unit.class[0]) || ['격투', '참격', '사격', '타격'].includes(team[z].unit.class[1])){
                        classes['Primary']++;
                    }
                    if(['자유', '강인', '박식', '야심'].includes(team[z].unit.class[0]) || ['자유', '강인', '박식', '야심'].includes(team[z].unit.class[1])){
                        classes['Secondary']++;
                    }
                }
                else{
                    if(['격투', '참격', '사격', '타격'].includes(team[z].unit.class)){
                        classes['Primary']++;
                    }
                    if(['자유', '강인', '박식', '야심'].includes(team[z].unit.class)){
                        classes['Secondary']++;
                    }
                }
            }
    ...
    var frankyClass = function() {
        ...
        for(var z=0;z<team.length;z++){
            if(team[z].unit){
                if(team[z].unit.class.length==2){
                    if(['격투', '참격', '사격', '타격'].includes(team[z].unit.class[0])){
                        classes[z] = team[z].unit.class[0];
                    }
                    else if(['격투', '참격', '사격', '타격'].includes(team[z].unit.class[1])){
